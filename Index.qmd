...
- `plotMD()` summarizes all genes by plotting log-fold change against average log-CPM, with DE genes highlighted
...
::: {.content-visible when-format="revealjs"}
## Useful Graphical Representations of DE Results
:::

```{r, fig.width=50, fig.height=75}
library(gplots)
